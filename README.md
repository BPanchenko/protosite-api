...
<p>
	...
	<dl>
		<dt><q>access_token</q></dt>
			<dd>
				Ключ доступа, необходимый для запросов, требующих определенных прав доступа к данным или их изменению. Определяет <b>текущего или авторизованного пользователя API</b>.<br>
