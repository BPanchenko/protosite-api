		...
		<dt><q>where</q></dt>
			<dd>
				<p>
					...
					Аргументы логического выражения разделяются символом ':'(равно) или '!:'(не равно).
				<p>
				<blockquote>
					Фреймворк проверяет наличие полей в источнике данных сущности, которые были переданы в выражениях параметра.<br>
					Использование знака равенства, для строкового поля источника данных, подразумевает его замену на выражение ' LIKE ' в запросе выборки.<br>
