...
<p>
	...
	<dl>
		...
		<dt><q>fallback</q></dt>
			<dd>
            	Фреймворк переключается в режим возврата статических данных из JSON-файлов дирректории <q>static</q>, путь к которой определяется константой <q>STATIC_DIR</q>. Название файла составляется из элементов конечной точки разделённых символом нижнего подчёркивания <q>_</q>. В случае если файл не был найден возвращается 404-я ошибка с описанием проблемы.
            </dd>
		<dt><q>fields</q></dt>
			<dd>
		...
		<dt><q>excluded_fields</q></dt>
			<dd>
                ...
                В общем случае исключаемыми из результатов выборки атрибутами, являются: <q>id</q> и <q>is_del</q>.
            </dd>
		<dt><q>where</q></dt>
			<dd>
				<p>
